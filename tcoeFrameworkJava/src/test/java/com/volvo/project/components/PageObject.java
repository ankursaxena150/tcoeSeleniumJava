...
public class PageObject extends TestBase{
    ...
    public static final String INTERNET_DB = System.getProperty("INTERNET_DB", "gorabas17.srv.volvo.com:1523/gipmrt01.srv.volvo.com");
    ...
    public static final String ISSUER_ROLE_PASSWORD = "wwe12";

    public static final String TEAMMEMBER_ROLE_USERNAME = "cs-ws-s-PctTeamMemb";
    public static final String TEAMMEMBER_ROLE_PASSWORD = "scs2";

    public static final String ENDCODED_CLIENT_SECRET = " Basic YXRob3MtYXBMnlNWnAxSzRGdWdpRmRlUTdaT0l2akJ5V1hOVXFFaDQ0eEQxSjN6REFMb0tNUWhZYzY=";
...
//    scrollIntoView(element1);
    ...
    private static class WaitForAllWebElements implements ExpectedCondition<Boolean> {
