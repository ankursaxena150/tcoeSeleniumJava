...
public interface IBusinessProcess2 extends IBusinessProcess {
  ...
  Com4jObject addFlowOutputParam(
          @MarshalAs(NativeType.Dispatch) Com4jObject pSrcBPParam,
          int iteration,
          String name);
  ...
  void deleteFlowOutputParam(
          @MarshalAs(NativeType.Dispatch) Com4jObject pShadowCompParam);
