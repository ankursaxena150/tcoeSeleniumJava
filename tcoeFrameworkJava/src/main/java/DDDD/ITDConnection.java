...
public interface ITDConnection extends Com4jObject {
  ...
  void initConnection(
          String serverName,
          @Optional @DefaultValue("") String domainName,
          @Optional @DefaultValue("") String domainPswd);
  ...
  void connectProject(
          String projectName,
          String userName,
          @Optional @DefaultValue("") String password);
  ...
  void purgeRuns(
          ...
          int keepLast,
          @MarshalAs(NativeType.VARIANT) Object dateUnit,
          int unitCount,
          boolean stepsOnly);
  ...
  @VTID(69)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject testSetTreeManager();
  ...
  void clientType(
          String newVal,
          @Optional @DefaultValue("") String rhs);
  ...
  @VTID(81)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject componentFolderFactory();
