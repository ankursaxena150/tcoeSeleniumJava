...
public interface IBusinessProcess extends ITest {
  ...
  @VTID(52)
  void deleteRTParam(
          @MarshalAs(NativeType.Dispatch) Com4jObject pRTParam);
  ...
  @VTID(54)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject addBPComponent(
          @MarshalAs(NativeType.Dispatch) Com4jObject pComponent);
  ...
  @VTID(57)
  void deleteGroup(
          @MarshalAs(NativeType.Dispatch) Com4jObject pBPGroup);
