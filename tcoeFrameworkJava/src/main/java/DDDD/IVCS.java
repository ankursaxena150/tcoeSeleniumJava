...
public interface IVCS extends Com4jObject {
  ...
  @VTID(10)
  void addObjectToVcs(
          @Optional @DefaultValue("1.1.1") String ignored,
          @Optional @DefaultValue("Object Created in VCS.") String comments);
  ...
  @VTID(23)
  void clearView(
          @Optional @DefaultValue("") String bstrVersion);
