...
public interface IAnalysisItemFolder extends IBaseField {
  ...
  /**
   * <p>
   * The AnalysisItemFolderFactory object for direct TestBase.children analysis item folders.
   * </p>
   * <p>
  ...
  Com4jObject analysisItemFolderFactory();
  ...
  @VTID(27)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject analysisItemFactory();
